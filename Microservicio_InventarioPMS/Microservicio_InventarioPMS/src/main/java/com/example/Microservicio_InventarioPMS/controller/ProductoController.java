...
public class ProductoController {
    ...
    // POST: Comprar
    // [NO USADO EN LA VERSION FINAL] La app actual simula el carrito localmente, 
    // pero no descuenta stock real por transacción en este endpoint.
    ...
    // POST: Reponer Stock rápido
    // [NO USADO EN LA VERSION FINAL] El administrador actualiza el stock directamente desde el metodo PUT
