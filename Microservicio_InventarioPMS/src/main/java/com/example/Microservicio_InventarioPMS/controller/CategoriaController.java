...
public class CategoriaController {
    ...
    // Los métodos POST/DELETE manuales los puedes dejar si quieres gestión manual extra, 
    // pero la App Android usará principalmente la lógica automática del ProductoController.
}